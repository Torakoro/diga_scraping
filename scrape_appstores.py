...
urls = {
    'google_play': [
        ...
        'https://play.google.com/store/apps/details?id=com.fosanis.android.cancer_companion', # Mika
        'https://play.google.com/store/apps/details?id=health.mindable.anxiety'
    ],
    'itunes': [
        'https://apps.apple.com/de/app/invirto/id1482760714',
        'https://apps.apple.com/de/app/id1511739470', # M-sense
        ...
        'https://apps.apple.com/de/app/id1465386878', # Mindable
        'https://apps.apple.com/de/app/mika-krebs-therapie-assistent/id1446551093'
    ]
}
